{
  ...
  "formElementGroups": [
    {
      "uuid": "db4482d2-885d-4e46-b228-9b391c2011b1",
      "name": "Address",
      "displayOrder": 1,
      "formElements": [
        {
        ...
        {
          "name": "Village",
          "uuid": "1f639729-cdc3-4518-953c-8581960adb0a",
          "keyValues": [],
          "concept": {
            "name": "Location",
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
    ...
    },
    {
      ...
      "formElements": [
        ...
        {
          "name": "Account code",
          "uuid": "625d098f-06c3-4916-8f0d-b159317e08c1",
          "keyValues": [],
          "concept": {
            "name": "Account code",
...
if(condition12 && condition22 ){
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "19b25a4a-6756-4baa-a7cf-f73561ba1a92",
          "keyValues": [],
          "concept": {
            "name": "Number of participants",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Number of participants",
          "uuid": "f8b36d89-4de1-452f-a1b6-9213a71f649d",
          "keyValues": [],
          "concept": {
      ...
      "formElements": [
        {
          ...
          "uuid": "c7dfe8b8-8bf7-4fd2-b834-fffcceee015b",
          "keyValues": [],
          "concept": {
            "name": "Before implementation",
