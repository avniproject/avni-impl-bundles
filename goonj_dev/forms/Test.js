...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
          ...
          "type": "SingleSelect",
          "uuid": "9e16fbb0-b23d-495a-80e1-2ea56062c050",
          "voided": true
        },
        {
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
      ...
      "timed": false,
      "uuid": "51fe2e8c-f469-4ae2-9fc4-0b650d1a1984",
      "voided": true
    },
    {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility);
          ...
          "type": "SingleSelect",
          "uuid": "86388568-5f0c-4277-83fb-a24b8209b0f7"
        },
        {
          "concept": {
            "active": true,
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
          ...
          "type": "SingleSelect",
          "uuid": "7fdd851f-0d72-490f-9897-1d4603c153ad"
        },
        {
          "concept": {
            "active": true,
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
          ...
          "type": "SingleSelect",
          "uuid": "86f74755-c706-4a6b-a9df-4e350a2dda5d",
          "voided": true
        },
        {
          "concept": {
