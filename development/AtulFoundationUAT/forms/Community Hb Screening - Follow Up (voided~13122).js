{
  "name": "Community Hb Screening - Follow Up (voided~13122)",
  "uuid": "ebc80d78-638e-4470-814e-09894074e9c6",
  "formType": "Encounter",
  "formElementGroups": [
    {
      "uuid": "9eb9197b-bc2f-4265-9e24-514ca727db12",
      "name": "Menstruation",
      "displayOrder": 1,
      "formElements": [
        {
          "name": "Regularity of Menstruation",
          "uuid": "5f683076-9357-4c61-b026-228805039ab0",
          "keyValues": [],
          "concept": {
            "name": "Regularity of Menstruation",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "6381696f-7e68-47af-8ada-48bcd07de51c",
          "keyValues": [],
          "concept": {
            "name": "Duration of Menstruation",
...
({params, imports}) => {
  ...
  const condition11 = new imports.rulesConfig.RuleCondition({encounter, formElement}).when.valueInEncounter("909ffa10-31d4-4c7b-a35b-9a9323a966d7").containsAnyAnswerConceptName("bf3255fa-481c-46e0-b652-6d83ad523d5b","1b00f912-6a00-4721-8e09-f76775d6c21f").and.when.gender.equals("Female").matches();
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
                    ...
                    "rules": [
                      {
                        ...
                        "rhs": {
                          ...
                          "answerConceptUuids": [
                            "bf3255fa-481c-46e0-b652-6d83ad523d5b",
                            "1b00f912-6a00-4721-8e09-f76775d6c21f"
                          ]
                        },
        ...
        },
        {
          ...
          "uuid": "637380b9-5b02-450a-b952-666b8aa3ca0d",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "0161e79a-2ca7-4b6e-805a-bb29ea2c64fc",
          "keyValues": [],
          "concept": {
            "name": "Absorbent material used most of the times",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "9af4cdaf-843c-46a8-8c5f-d209c147a81e",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  const condition11 = new imports.rulesConfig.RuleCondition({encounter, formElement}).when.gender.equals("Female").matches();
    ...
    {
      "uuid": "b60048f4-4aed-44f1-aee4-8dc7512708bb",
      "name": "Hb Details",
      "displayOrder": 2,
      "formElements": [
        {
          "name": "Hb",
          "uuid": "06642e1b-587c-47f8-9176-72d3b13a4da2",
          "keyValues": [],
          "concept": {
            "name": "Hb",
...
({params, imports}) => {
    ...
    return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors, answersToShow);
        ...
        },
        {
          ...
          "uuid": "57722bf5-cdaa-48f2-95be-cd7efd14e664",
          "keyValues": [],
          "concept": {
            "name": "No. of IFA tablets given at the time of screening",
...
({params, imports}) => {
    ...
    return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "c5de5c75-97c2-43ec-8c6d-7cf72277c457",
          "keyValues": [
            {
              "key": "editable",
              "value": false
...
({params, imports}) => {
    ...
    return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "8b400a0a-0957-4ade-972b-a9ba2d65f463",
          "keyValues": [],
          "concept": {
            "name": "IFA Tablets given during current visit",
        ...
        },
        {
          ...
          "uuid": "f4d082f7-4f58-4877-902e-36d8d5999389",
          "keyValues": [],
          "concept": {
            "name": "No. of IFA Tablets given in current visit",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "adabbe1d-e7da-4271-a259-a4128bb3ba6a",
          "keyValues": [],
          "concept": {
            "name": "Does the Albendazole tablet consumed during the last visit?",
        ...
        },
        {
          ...
          "uuid": "9536a406-49f4-4cd3-8af9-f5f184f3595c",
          "keyValues": [],
          "concept": {
            "name": "Does the Albendazole Tablet given during current visit?",
    ...
    {
      "uuid": "f7eaaea4-1537-4b7d-a36c-2765dc130ff9",
      "name": "Other Details",
      "displayOrder": 3,
      "formElements": [
        {
          "name": "24 hours dietary diversity",
          "uuid": "f0de5c7d-a77c-4a28-ae38-92d43fbfeeca",
          "keyValues": [],
          "concept": {
            "name": "24 hours dietary diversity",
        ...
        },
        {
          ...
          "uuid": "b5074d97-591a-477a-96c7-e2fd9549a4d1",
          "keyValues": [],
          "concept": {
            "name": "Other diet",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "d2a0673a-31d4-49a6-85ae-1422696ee3ab",
          "keyValues": [],
          "concept": {
            "name": "How many meals do you consume in a day?",
        ...
        },
        {
          ...
          "uuid": "a4d80a6d-fcc1-436a-a9ac-8d156881e14d",
          "keyValues": [],
          "concept": {
            "name": "Presence of any comorbidity",
        ...
        },
        {
          ...
          "uuid": "9c1a8ba5-01b6-4a7f-bd34-2137b2f07c31",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Addiction",
          "uuid": "c8d82371-443c-4346-b489-d7ecb2367526",
          "keyValues": [],
          "concept": {
            "name": "Addiction",
        ...
        },
        {
          ...
          "uuid": "879198f5-37fa-4887-9689-f51329707339",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "7b684b59-e98e-483e-b61c-5901296974ef",
          "keyValues": [],
          "concept": {
            "name": "Counselling given on",
