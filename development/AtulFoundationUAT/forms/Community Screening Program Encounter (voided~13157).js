{
  "name": "Community Screening Program Encounter (voided~13157)",
  "uuid": "cd46d7f1-632e-4443-bfb8-340e3bd2c90b",
  "formType": "ProgramEncounter",
  "formElementGroups": [
    {
      "uuid": "8f318627-9248-4996-a51c-bf184ac6542c",
      "name": "Basic Details",
      "displayOrder": 1,
      "formElements": [
        {
          "name": "Type of the Beneficiary",
          "uuid": "c6b8ccbb-d882-40ac-ab0d-e67016ec1110",
          "keyValues": [],
          "concept": {
            "name": "Type of the Beneficiary",
        ...
        },
        {
          ...
          "uuid": "231c1481-2134-4134-a413-fcb155ad3708",
          "keyValues": [],
          "concept": {
            "name": "Other Beneficiary, please specify",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "05f1439a-6a0e-4672-9ae9-2a46838324ea",
          "keyValues": [],
          "concept": {
            "name": "Name of the school",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "2b2ee6fd-0496-452c-ad03-ed6d12d3a1eb",
          "keyValues": [],
          "concept": {
            "name": "Regularity of Menstruation",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Regularity of menstruation",
          "uuid": "e80cba53-8ae3-4386-8991-07048f3cb939",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "f8460928-d169-4ce1-a0c9-71aa9ea9baec",
          "keyValues": [],
          "concept": {
            "name": "Duration of Menstruation",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "9237ccbc-0dea-486c-98b8-6faa4254dea5",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "517c38d2-5118-4780-8bc6-62ecc33ae1ac",
          "keyValues": [],
          "concept": {
            "name": "Absorbent material used most of the times",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "a3664d88-7319-4b48-9b1b-db6f282249ed",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Absorbent material used most of the times",
          "uuid": "f77162bd-0830-45ab-8537-c7b20095c34c",
          "keyValues": [],
          "concept": {
            "name": "Absorbent material used most of the times",
            "uuid": "50d64a4c-879b-4658-a722-27b43b2e9c55",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Other Duration of menstruation, please specify",
          "uuid": "4d87d4a8-cac1-40e7-937d-47a9f96bafaa",
          "keyValues": [],
          "concept": {
    ...
    {
      "uuid": "bc6e9627-bb69-45ab-aef7-56ac005c5c2d",
      "name": "Menstruation",
      "displayOrder": 2,
      "formElements": [
        {
          "name": "Regularity of menstruation",
          "uuid": "794f96af-b02a-4891-9eeb-8e06d012f465",
          "keyValues": [],
          "concept": {
            "name": "Regularity of Menstruation",
            "uuid": "909ffa10-31d4-4c7b-a35b-9a9323a966d7",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Absorbent material used most of the times",
          "uuid": "160bf896-ee83-4c2b-8c88-ac952368fb92",
          "keyValues": [],
          "concept": {
            "name": "Absorbent material used most of the times",
            "uuid": "50d64a4c-879b-4658-a722-27b43b2e9c55",
...
({params, imports}) => {
  ...
  const condition11 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.gender.equals("Female").matches();
    ...
    {
      "uuid": "f7690ffc-7a15-4717-a34b-5d23d1286c1e",
      "name": "Hb Details",
      "displayOrder": 3,
      "formElements": [
        {
          "name": "Hb",
          "uuid": "5d844d80-b88f-4997-ad20-81ca021397be",
          "keyValues": [],
          "concept": {
            "name": "Hb",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "a4527ff4-5aa7-43ff-bb28-3d2121c0b39b",
          "keyValues": [],
          "concept": {
            "name": "IFA Tablets given during current visit",
        ...
        },
        {
          ...
          "uuid": "149e3f62-4e9c-4b3a-b3ce-f2fd238fbae5",
          "keyValues": [],
          "concept": {
            "name": "No. of IFA Tablets given in current visit",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "43c96218-2361-44b2-983b-b70535a65a2d",
          "keyValues": [],
          "concept": {
            "name": "Does the Albendazole Tablet given during current visit?",
    ...
    {
      "uuid": "575232f1-dd2d-4fc9-9f71-0e3ee0bb195c",
      "name": "Other Details",
      "displayOrder": 4,
      "formElements": [
        {
          "name": "Type of diet",
          "uuid": "dfceab5e-3491-40f5-9b94-33f6215651ac",
          "keyValues": [],
          "concept": {
            "name": "Type of diet",
        ...
        },
        {
          ...
          "uuid": "362747e8-dae0-4c3e-818a-3497b6bdf6f4",
          "keyValues": [],
          "concept": {
            "name": "24 hours dietary diversity",
        ...
        },
        {
          ...
          "uuid": "5f6d4057-5891-40d3-9fe2-d5c9cfafe2bc",
          "keyValues": [],
          "concept": {
            "name": "Other diet",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "2c28167d-78d9-4f44-8070-fbcb19cde6ab",
          "keyValues": [],
          "concept": {
            "name": "How many meals do you consume in a day?",
        ...
        },
        {
          ...
          "uuid": "7e5c5f9c-acba-4eea-b835-284c5037e2aa",
          "keyValues": [],
          "concept": {
            "name": "Presence of any comorbidity",
        ...
        },
        {
          ...
          "uuid": "287ed467-0961-4c8d-a834-9b872bdcf72a",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Addiction",
          "uuid": "fc6faa79-5f44-4091-b4fc-7e9571bde88b",
          "keyValues": [],
          "concept": {
            "name": "Addiction",
        ...
        },
        {
          ...
          "uuid": "243cba87-0627-483d-a4bc-49164ef44c0d",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "0630645c-3ebf-471d-9c53-9eb9010488b3",
          "keyValues": [],
          "concept": {
            "name": "Counselling given on",
