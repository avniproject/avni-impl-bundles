{
  "name": "Community Hb Screening  Encounter",
  "uuid": "ea142cac-c83b-4a87-bfec-f573fd633329",
  "formType": "ProgramEncounter",
  "formElementGroups": [
    {
      "uuid": "3dbd8069-26a8-481f-a3c2-cc509f58f5c0",
      "name": "Basic Details",
      "displayOrder": 1,
      "formElements": [
        {
          "name": "Type of the Beneficiary",
          "uuid": "e128e0c0-0eff-4779-8f6d-e38563a18f61",
          "keyValues": [],
          "concept": {
            "name": "Type of the Beneficiary",
        ...
        },
        {
          ...
          "uuid": "cf76a413-5adc-4d10-adfb-b41ba4e732cd",
          "keyValues": [],
          "concept": {
            "name": "Other Beneficiary, please specify",
...
({params, imports}) => {
  ...
  const condition11 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.valueInEncounter("01217ff2-82eb-4614-a2d9-29ffce1e58d5").containsAnswerConceptName("cf383e34-8ed9-47bd-9e86-41f726773a1f").matches();
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
                    ...
                    "rules": [
                      {
                        "lhs": {
                          "type": "concept",
                          "scope": "encounter",
                          "conceptName": "Type of the Beneficiary",
                          "conceptUuid": "01217ff2-82eb-4614-a2d9-29ffce1e58d5",
        ...
        },
        {
          ...
          "uuid": "209e4d96-7418-4726-941e-580ef4d82a4a",
          "keyValues": [],
          "concept": {
            "name": "Name of the school",
...
({params, imports}) => {
  ...
  const condition11 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.valueInEncounter("01217ff2-82eb-4614-a2d9-29ffce1e58d5").containsAnyAnswerConceptName("677367d1-939c-4551-b5a9-1068f8475ead","3dbc52a4-22e8-4569-bef4-c28143af6885","b55e5125-e4d6-45d7-8095-a94d4404cbb5","85c80ccc-d3da-4537-abba-6dbe78198226").matches();
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
                    ...
                    "rules": [
                      {
                        ...
                        "rhs": {
                          "type": "answerConcept",
                          "answerConceptNames": [
                            "School going Male 15-19 years (Falls in other school)",
                            "School going Female 15-19 years (Falls in other school)",
                            "School going Male 10-14 years (Falls in other school)",
                            "School going Female 10-14 years (Falls in other school)"
                          ],
                          "answerConceptUuids": [
                            "677367d1-939c-4551-b5a9-1068f8475ead",
                            "3dbc52a4-22e8-4569-bef4-c28143af6885",
                            "b55e5125-e4d6-45d7-8095-a94d4404cbb5",
                            "85c80ccc-d3da-4537-abba-6dbe78198226"
                          ]
                        },
        ...
        },
        {
          ...
          "uuid": "ceb99434-e50c-4491-b09f-eaca71f4be2a",
          "keyValues": [],
          "concept": {
            "name": "Regularity of Menstruation",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Regularity of menstruation",
          "uuid": "88e66c59-8bcb-4de8-9954-b189a0b0006e",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "9ab481a9-d5e7-4f5d-95c9-87554bf644cc",
          "keyValues": [],
          "concept": {
            "name": "Duration of Menstruation",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "e0482803-917f-481a-8b04-1e4a8a20843d",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "97d4a794-ae24-42e2-9ca8-138d458020c7",
          "keyValues": [],
          "concept": {
            "name": "Absorbent material used most of the times",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "414b1ae5-c527-44ea-a4a7-24821228e4ed",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Absorbent material used most of the times",
          "uuid": "b85b5fcb-dbc1-4d8f-a840-7b47ba67e774",
          "keyValues": [],
          "concept": {
            "name": "Absorbent material used most of the times",
            "uuid": "50d64a4c-879b-4658-a722-27b43b2e9c55",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Other Duration of menstruation, please specify",
          "uuid": "75253c5b-6738-45f9-9e4e-db326bf5e8c2",
          "keyValues": [],
          "concept": {
    ...
    {
      "uuid": "03b77927-1638-4925-869e-f092784026b7",
      "name": "Menstruation",
      "displayOrder": 2,
      "formElements": [
        {
          "name": "Regularity of menstruation",
          "uuid": "29fa61bd-a822-4011-8e19-eb3a4089c127",
          "keyValues": [],
          "concept": {
            "name": "Regularity of Menstruation",
            "uuid": "909ffa10-31d4-4c7b-a35b-9a9323a966d7",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Absorbent material used most of the times",
          "uuid": "b9b0f6fc-2396-4e8a-8a16-a9d06f6889b2",
          "keyValues": [],
          "concept": {
            "name": "Absorbent material used most of the times",
            "uuid": "50d64a4c-879b-4658-a722-27b43b2e9c55",
...
({params, imports}) => {
  ...
  const condition11 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.gender.equals("Female").matches();
    ...
    {
      "uuid": "4fc48daa-44b3-4433-9359-42be8eaef431",
      "name": "Hb Details",
      "displayOrder": 3,
      "formElements": [
        {
          "name": "Hb",
          "uuid": "6f838ca4-5011-4c0c-96d4-19f9233e04ab",
          "keyValues": [],
          "concept": {
            "name": "Hb",
...
({params, imports}) => {
  ...
  const condition11 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.gender.equals("Female").and.when.ageInYears.greaterThanOrEqualTo(10).and.when.ageInYears.lessThanOrEqualTo(49).matches();
    
  const condition12 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.gender.equals("Male").and.when.ageInYears.greaterThanOrEqualTo(10).and.when.ageInYears.lessThan(15).matches();
    
  const condition13 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.gender.equals("Male").and.when.ageInYears.greaterThanOrEqualTo(15).and.when.ageInYears.lessThan(49).matches();
    
  const condition14 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.gender.equals("Male").and.when.ageInYears.greaterThan(19).matches();
  
  const condition24 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.gender.equals("Female").and.when.ageInYears.greaterThan(49).matches();
  
  const condition34 = new imports.rulesConfig.RuleCondition({programEncounter, formElement}).when.ageInYears.lessThan(10).matches();
  
  if(condition11 ) {
    _.forEach(["cf2ff4bd-38cb-4b94-a743-fd4b91d2cab0","2083ee91-6b5b-43a7-accf-24af1f2d69fe"], (answer) => {
    ...
    if(condition13 ) {
    _.forEach(["cb5b6fe3-bd8b-434e-ac8b-9ef7b324c8aa","1d0c6b49-6cfe-44fb-9aee-c1a1108fb394"], (answer) => {
        const answerToSkip = formElement.getAnswerWithConceptUuid(answer);
        if (answerToSkip) answersToSkip.push(answerToSkip);
    });
};
    visibility = !(condition14 || condition24 || condition34 );
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
              ...
              "actions": [
                {
                  "details": {
                    "answersToSkip": [
                      ...
                      "More than 12.9 gm/dl - Normal"
                    ],
                    "answerUuidsToSkip": [
                      "cf2ff4bd-38cb-4b94-a743-fd4b91d2cab0",
                      "2083ee91-6b5b-43a7-accf-24af1f2d69fe"
                    ]
                  },
              ...
              "actions": [
                {
                  "details": {
                    "answersToSkip": [
                      ...
                      "More than 11.9 gm/dl-Normal"
                    ],
                    "answerUuidsToSkip": [
                      "cb5b6fe3-bd8b-434e-ac8b-9ef7b324c8aa",
                      "1d0c6b49-6cfe-44fb-9aee-c1a1108fb394"
                    ]
                  },
                  "actionType": "skipAnswers"
                }
        ...
        },
        {
          ...
          "uuid": "76867ea3-2f62-42db-a222-035b58c8c110",
          "keyValues": [],
          "concept": {
            "name": "IFA Tablets given during current visit",
        ...
        },
        {
          ...
          "uuid": "269f2f28-7092-4e0b-b85e-2db50a59eb42",
          "keyValues": [],
          "concept": {
            "name": "No. of IFA Tablets given in current visit",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "3b0325f2-1b48-4567-9e73-702b4a4437a6",
          "keyValues": [],
          "concept": {
            "name": "Does the Albendazole Tablet given during current visit?",
    ...
    {
      "uuid": "7051c29c-d030-4911-8d63-597168b8a152",
      "name": "Other Details",
      "displayOrder": 4,
      "formElements": [
        {
          "name": "Type of diet",
          "uuid": "72962eb5-4c0b-412e-99a7-b63391ba409d",
          "keyValues": [],
          "concept": {
            "name": "Type of diet",
        ...
        },
        {
          ...
          "uuid": "e5423d15-e1d9-48c2-8948-44ee3e44a6e1",
          "keyValues": [],
          "concept": {
            "name": "24 hours dietary diversity",
        ...
        },
        {
          ...
          "uuid": "d3efc673-57cd-453a-80b7-7af7ed004e63",
          "keyValues": [],
          "concept": {
            "name": "Other diet",
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "488dfd97-5cfb-4f21-b733-e9de3cc1dc16",
          "keyValues": [],
          "concept": {
            "name": "How many meals do you consume in a day?",
        ...
        },
        {
          ...
          "uuid": "e002abc0-19a2-4d18-9a47-ecba32f5011e",
          "keyValues": [],
          "concept": {
            "name": "Presence of any comorbidity",
        ...
        },
        {
          ...
          "uuid": "21f08174-0b24-4fee-a918-e5d87573a519",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        {
          "name": "Addiction",
          "uuid": "00468f36-6e02-42ea-93b3-c0ab365f7f9e",
          "keyValues": [],
          "concept": {
            "name": "Addiction",
        ...
        },
        {
          ...
          "uuid": "a8f75a2d-6b01-4f9c-9ea1-1ef577a20073",
          "keyValues": [],
          "concept": {
...
({params, imports}) => {
  ...
  return new imports.rulesConfig.FormElementStatus(formElement.uuid, visibility, value, answersToSkip, validationErrors);
        ...
        },
        {
          ...
          "uuid": "e6ce1a31-5aad-4305-a903-ca3c8c543991",
          "keyValues": [
            {
              "key": "ExcludedAnswers",
              "value": [
                "To take Albendazole Tablet twice in a year"
              ]
            }
          ],
          "concept": {
...
({ params, imports }) => {
    ...
    const isAlreadyScheduled = programEncounter.programEnrolment.getEncountersOfType("Community Hb Screening - Follow Up").length > 0;
    
    if(isActiveInProgram && !isAlreadyScheduled){
        const earliestDate = moment(programEncounter.encounterDateTime).add(3, 'month').startOf('day').toDate();
        const maxDate = moment(earliestDate).add(10, 'days').endOf('day').toDate();
        scheduleBuilder.add({name: "Community Followup 1", encounterType: "Community Hb Screening - Follow Up", earliestDate, maxDate});  
    }
